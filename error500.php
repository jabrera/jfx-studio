...
<div id="whole">
	...
	<div id="mainContent">
		...
		<div id="containerBody">
			...
			<div id="conBase">
				<div id="conPad">
				<h1><img src="images/default/bg/logo_mini.png" class="logomini">Error 500 - Internal server error</h1><hr class="white_middle">
				<h3>Something went wrong! We will fix this problem as soon as we can.</h3>
				</div>
			</div>
